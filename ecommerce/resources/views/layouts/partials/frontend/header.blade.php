        ...
        <div class="flex items-center justify-between h-16 gap-4">
            ...
            <form action="{{ route('products.index') }}" method="GET" class="hidden lg:flex flex-1 max-w-xs">
                <div class="relative w-full">
                    ...
                    <svg class="w-4 h-4 absolute top-1/2 -translate-y-1/2 start-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35M11 18a7 7 0 100-14 7 7 0 000 14z"/></svg>
                </div>
            </form>
