...
from orm import AppUser, Vendor, VendorStatus
...
def approve_vendor(
    ...
    _user: AppUser = Depends(require_permission("vendor.approve")),
):
    """Admin action — mark a pending vendor as approved (requires `vendor.approve`)."""
